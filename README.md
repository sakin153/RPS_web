...
---
**⚡ 100% клиентская обработка — без сервера!**
- Модель загружается и выполняется **прямо в вашем браузере**
- Все вычисления происходят на **вашем устройстве** (GPU/CPU)
- **Никаких запросов** на сервер — ваши жесты не покидают компьютер
